# Generated by Django 4.2.5 on 2023-09-18 13:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('washroom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tickets.washroom')),
            ],
        ),
        migrations.AddField(
            model_name='customuser',
            name='roles',
            field=models.ManyToManyField(blank=True, to='tickets.role'),
        ),
        migrations.AddField(
            model_name='customuser',
